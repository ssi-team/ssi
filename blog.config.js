...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || '𝘀𝘀𝗶.𝘵𝘦𝘢𝘮', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '𝖲𝖺𝖿𝖾 𝙎𝙪𝙥𝙚𝙧 𝗜𝗻𝘁𝗲𝗹𝗹𝗶𝗴𝗲𝗻𝗰𝗲', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://ssi.team', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'Notion, 博客, ssi, 安全超级智能, ilya, OpenAI', // 网站关键词 英文逗号隔开
